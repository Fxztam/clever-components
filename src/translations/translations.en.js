...
export const translations = {
  ...
  'cc-env-var-editor-expert.example': () => sanitize`Format: <code>VARIABLE_NAME="variable value"</code> <br> Every variable must be separated by a line break, <a href="https://clever-cloud.com/#environment-variables-rules-and-format">learn more</a>.`,
  ...
  'cc-env-var-editor-json.example': () => sanitize`Format: <code>{ "name": "THE_NAME", "value": "the value" }</code> <br> Array of objects following the above format, <a href="https://clever-cloud.com/#environment-variables-rules-and-format">learn more</a>.`,
  //#endregion
