...
export const translations = {
  ...
  'cc-env-var-editor-expert.example': () => sanitize`Format : <code>NOM_DE_LA_VARIABLE="valeur de la variable"</code> <br> Chaque variable doit être séparée par des sauts de ligne, <a href="https://clever-cloud.com/#environment-variables-rules-and-format">en savoir plus</a>.`,
  //#endregion
  ...
  'cc-env-var-editor-json.example': () => sanitize`Format : <code>{ "name": "NOM_VAR", "value": "la valeur" }</code> <br> Tableau d'objets respectant le format ci-dessus, <a href="https://clever-cloud.com/#environment-variables-rules-and-format">en savoir plus</a>.`,
  //#endregion
